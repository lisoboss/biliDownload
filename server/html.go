...
!function () {
    function a(a) { //a=url
        this.mode = 4, this.data = a, this.parsedData = [];
    ...
    function n() {
        var a = !1, b = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.27 Safari/537.36";
        return /android/i.test(b) && (a = !0, aMat = b.toString().match(/android ([0-9]\.[0-9])/i), aMat && aMat[1] && (a = parseFloat(aMat[1]))), a
    }

    function r(a, b) { // b=2
        // c = 1 , e = 90 , f = 0, l = [[17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34], [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137], [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250], [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403], [1003, 779, 565, 439], [1091, 857, 611, 461], [1171, 911, 661, 511], [1273, 997, 715, 535], [1367, 1059, 751, 593], [1465, 1125, 805, 625], [1528, 1190, 868, 658], [1628, 1264, 908, 698], [1732, 1370, 982, 742], [1840, 1452, 1030, 790], [1952, 1538, 1112, 842], [2068, 1628, 1168, 898], [2188, 1722, 1228, 958], [2303, 1809, 1283, 983], [2431, 1911, 1351, 1051], [2563, 1989, 1423, 1093], [2699, 2099, 1499, 1139], [2809, 2213, 1579, 1219], [2953, 2331, 1663, 1273]]
        //                         g = 40
    ...
    QRCode = function (a, b) {
        ...
        this._el = a
        this._oQRCode = null
        window._oDrawing = new q(this._el, this._htOption)
        this._oDrawing = window._oDrawing
        console.log(this)
        this._htOption.text && QRCode.prototype.makeCode(this._htOption.text)
    }, QRCode.prototype.makeCode = function (url) {
        // r(url, 2) == 9
        console.log(11111111111111111)
        this._oDrawing = window._oDrawing
        this._oQRCode = new b(r(url, 2), 2)
        this._oQRCode.addData(url)
        this._oQRCode.make(),console.log(this)
