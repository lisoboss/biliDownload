...
BINARY_MACOS_AMD64=${BINARY_NAME}-mac-amd64
BINARY_MACOS_ARM64=${BINARY_NAME}-mac-arm64
BINARY_WINDOWS_AMD64=${BINARY_NAME}-win-amd64.exe
BINARY_WINDOWS_ARM64=${BINARY_NAME}-win-arm64.exe
BINARY_PACK=${BINARY_NAME}.zip
